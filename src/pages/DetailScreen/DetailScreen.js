...
const DetailScreen = props  => {
    ...
    return (
        <div>
            <Link to="/"><Button variant="outlined" color="secondary" style={{color:"#ffffff", padding:"5px", margin:"5px"}}>VOLTAR</Button></Link>
            ...
            <div className="detailBox" style={{fontFamily:"sans-serif",  margin: "200px 0px -100px 800px", backgroundColor:"#808080", color: "#FFFFFF", borderRadius:"20px", width:"300px", height:"130px"}}>
                ...
                <div style={{margin:"-135px 0px 0px 200px"}}>
